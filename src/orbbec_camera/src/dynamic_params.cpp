...
Parameters::Parameters(rclcpp::Node *node)
  ...
  params_backend_.addOnSetParametersCallback(
      [this](const vector<rclcpp::Parameter> &parameters) {
...
rclcpp::ParameterValue Parameters::setParam(
    const string &param_name, rclcpp::ParameterValue initial_value,
    const function<void(const rclcpp::Parameter &)> &func,
  ...
  if (func) {
    ...
    param_functions_[param_name] = vector<function<void(const rclcpp::Parameter &)>>();
  }
...
template <class T>
void Parameters::setParamT(string param_name, rclcpp::ParameterValue initial_value, T &param,
                           function<void(const rclcpp::Parameter &)> func,
...
void Parameters::setParamValue(T &param, const T &value) {
  param = value;
  try {
    string param_name = param_names_.at(&param);
...
void Parameters::removeParam(const string &param_name) {
  node_->undeclare_parameter(param_name);
  param_functions_.erase(param_name);
}

template void Parameters::setParamT<bool>(string param_name,
                                          rclcpp::ParameterValue initial_value, bool &param,
                                          function<void(const rclcpp::Parameter &)> func,
                                          rcl_interfaces::msg::ParameterDescriptor descriptor);

template void Parameters::setParamT<int>(string param_name,
                                         rclcpp::ParameterValue initial_value, int &param,
                                         function<void(const rclcpp::Parameter &)> func,
                                         rcl_interfaces::msg::ParameterDescriptor descriptor);

template void Parameters::setParamT<double>(string param_name,
