...
void OBCameraNode::setupCameraCtrlServices() {
  ...
  for (auto stream_index : IMAGE_STREAMS) {
    ...
    string service_name = "get_" + stream_name + "_exposure";
    get_exposure_srv_[stream_index] = node_->create_service<GetInt32>(
        service_name,
        [this, stream_index = stream_index](const shared_ptr<GetInt32::Request> request,
                                            shared_ptr<GetInt32::Response> response) {
    ...
    set_exposure_srv_[stream_index] = node_->create_service<SetInt32>(
        service_name,
        [this, stream_index = stream_index](const shared_ptr<SetInt32::Request> request,
                                            shared_ptr<SetInt32::Response> response) {
    ...
    set_auto_exposure_srv_[stream_index] = node_->create_service<SetBool>(
        service_name,
        [this, stream_index = stream_index](const shared_ptr<SetBool::Request> request,
                                            shared_ptr<SetBool::Response> response) {
  ...
  set_fan_work_mode_srv_ = node_->create_service<SetInt32>(
      "set_fan_work_mode", [this](const shared_ptr<SetInt32::Request> request,
                                  shared_ptr<SetInt32::Response> response) {
        setFanWorkModeCallback(request, response);
      });
  set_floor_enable_srv_ = node_->create_service<SetBool>(
      "set_floor_enable", [this](const shared_ptr<rmw_request_id_t> request_header,
                                 const shared_ptr<SetBool::Request> request,
                                 shared_ptr<SetBool::Response> response) {
        setFloorEnableCallback(request_header, request, response);
      });
  set_laser_enable_srv_ = node_->create_service<SetBool>(
      "set_laser_enable", [this](const shared_ptr<rmw_request_id_t> request_header,
                                 const shared_ptr<SetBool::Request> request,
                                 shared_ptr<SetBool::Response> response) {
        setLaserEnableCallback(request_header, request, response);
      });
  set_ldp_enable_srv_ = node_->create_service<SetBool>(
      "set_ldp_enable", [this](const shared_ptr<rmw_request_id_t> request_header,
                               const shared_ptr<SetBool::Request> request,
                               shared_ptr<SetBool::Response> response) {
        setLdpEnableCallback(request_header, request, response);
      });
  get_ldp_status_srv_ = node_->create_service<GetBool>(
      "get_ldp_status", [this](const shared_ptr<rmw_request_id_t> request_header,
                               const shared_ptr<GetBool::Request> request,
                               shared_ptr<GetBool::Response> response) {
        (void)request_header;
        getLdpStatusCallback(request, response);
      });

  get_white_balance_srv_ = node_->create_service<GetInt32>(
      "get_white_balance", [this](const shared_ptr<GetInt32::Request> request,
                                  shared_ptr<GetInt32::Response> response) {
        getWhiteBalanceCallback(request, response);
      });

  set_white_balance_srv_ = node_->create_service<SetInt32>(
      "set_white_balance", [this](const shared_ptr<SetInt32::Request> request,
                                  shared_ptr<SetInt32::Response> response) {
        setWhiteBalanceCallback(request, response);
      });
  get_auto_white_balance_srv_ = node_->create_service<GetInt32>(
      "get_auto_white_balance", [this](const shared_ptr<GetInt32::Request> request,
                                       shared_ptr<GetInt32::Response> response) {
        getAutoWhiteBalanceCallback(request, response);
      });
  set_auto_white_balance_srv_ = node_->create_service<SetBool>(
      "set_auto_white_balance", [this](const shared_ptr<SetBool::Request> request,
                                       shared_ptr<SetBool::Response> response) {
        setAutoWhiteBalanceCallback(request, response);
      });
  get_device_srv_ = node_->create_service<GetDeviceInfo>(
      "get_device_info", [this](const shared_ptr<GetDeviceInfo::Request> request,
                                shared_ptr<GetDeviceInfo::Response> response) {
        getDeviceInfoCallback(request, response);
      });
  get_sdk_version_srv_ = node_->create_service<GetString>(
      "get_sdk_version",
      [this](const shared_ptr<GetString::Request> request,
             shared_ptr<GetString::Response> response) { getSDKVersion(request, response); });
  save_images_srv_ = node_->create_service<std_srvs::srv::Empty>(
      "save_images", [this](const shared_ptr<std_srvs::srv::Empty::Request> request,
  ...
  save_point_cloud_srv_ = node_->create_service<std_srvs::srv::Empty>(
      "save_point_cloud", [this](const shared_ptr<std_srvs::srv::Empty::Request> request,
                                 shared_ptr<std_srvs::srv::Empty::Response> response) {
        savePointCloudCallback(request, response);
      });
  switch_ir_camera_srv_ = node_->create_service<SetString>(
      "switch_ir", [this](const shared_ptr<SetString::Request> request,
                          shared_ptr<SetString::Response> response) {
        switchIRCameraCallback(request, response);
      });
  set_ir_long_exposure_srv_ = node_->create_service<SetBool>(
      "set_ir_long_exposure", [this](const shared_ptr<SetBool::Request> request,
                                     shared_ptr<SetBool::Response> response) {
        setIRLongExposureCallback(request, response);
      });
}

void OBCameraNode::setExposureCallback(const shared_ptr<SetInt32::Request>& request,
                                       shared_ptr<SetInt32::Response>& response,
...
void OBCameraNode::getGainCallback(const shared_ptr<GetInt32::Request>& request,
                                   shared_ptr<GetInt32::Response>& response,
                                   const stream_index_pair& stream_index) {
  (void)request;
  auto stream = stream_index.first;
...
void OBCameraNode::setGainCallback(const shared_ptr<SetInt32 ::Request>& request,
                                   shared_ptr<SetInt32::Response>& response,
                                   const stream_index_pair& stream_index) {
  auto stream = stream_index.first;
...
void OBCameraNode::getWhiteBalanceCallback(const shared_ptr<GetInt32::Request>& request,
                                           shared_ptr<GetInt32::Response>& response) {
  (void)request;
  try {
...
void OBCameraNode::setWhiteBalanceCallback(const shared_ptr<SetInt32 ::Request>& request,
                                           shared_ptr<SetInt32 ::Response>& response) {
  try {
...
void OBCameraNode::getAutoWhiteBalanceCallback(const shared_ptr<GetInt32::Request>& request,
                                               shared_ptr<GetInt32::Response>& response) {
  (void)request;
  try {
...
void OBCameraNode::setAutoWhiteBalanceCallback(const shared_ptr<SetBool::Request>& request,
                                               shared_ptr<SetBool::Response>& response) {
  try {
...
void OBCameraNode::setAutoExposureCallback(
    const shared_ptr<std_srvs::srv::SetBool::Request>& request,
...
void OBCameraNode::setFanWorkModeCallback(const shared_ptr<SetInt32::Request>& request,
                                          shared_ptr<SetInt32::Response>& response) {
  (void)response;
...
void OBCameraNode::getExposureCallback(const shared_ptr<GetInt32::Request>& request,
                                       shared_ptr<GetInt32 ::Response>& response,
                                       const stream_index_pair& stream_index) {
  (void)request;
  auto stream = stream_index.first;
...
void OBCameraNode::getDeviceInfoCallback(const shared_ptr<GetDeviceInfo::Request>& request,
                                         shared_ptr<GetDeviceInfo::Response>& response) {
  (void)request;
  try {
...
void OBCameraNode::getSDKVersion(const shared_ptr<GetString::Request>& request,
                                 shared_ptr<GetString::Response>& response) {
  (void)request;
  try {
    auto device_info = device_->getDeviceInfo();
    nlohmann::json data;
...
void OBCameraNode::setMirrorCallback(const shared_ptr<SetBool::Request>& request,
                                     shared_ptr<SetBool::Response>& response,
                                     const stream_index_pair& stream_index) {
  (void)request;
  auto stream = stream_index.first;
...
void OBCameraNode::getLdpStatusCallback(const shared_ptr<GetBool::Request>& request,
                                        shared_ptr<GetBool::Response>& response) {
  (void)request;
  try {
...
void OBCameraNode::toggleSensorCallback(const shared_ptr<SetBool::Request>& request,
                                        shared_ptr<SetBool::Response>& response,
                                        const stream_index_pair& stream_index) {
  string msg;
  if (request->data) {
...
void OBCameraNode::saveImageCallback(const shared_ptr<std_srvs::srv::Empty::Request>& request,
                                     shared_ptr<std_srvs::srv::Empty::Response>& response) {
  (void)request;
  (void)response;
...
void OBCameraNode::savePointCloudCallback(
    const shared_ptr<std_srvs::srv::Empty::Request>& request,
    shared_ptr<std_srvs::srv::Empty::Response>& response) {
  (void)request;
  (void)response;
...
void OBCameraNode::switchIRCameraCallback(const shared_ptr<SetString::Request>& request,
                                          shared_ptr<SetString::Response>& response) {
